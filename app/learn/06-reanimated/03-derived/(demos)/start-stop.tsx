...
export default function CancelAnimationScreen() {
  ...
  return (
    <View className="flex-1 items-center justify-center gap-12 bg-cream-50 dark:bg-night-800">
      <Animated.View style={animatedStyle} className="h-24 w-24 rounded-xs border border-primary-300 bg-primary-200 dark:border-primary-700 dark:bg-primary-500/40" />
