  ...
  return (
    <View className="flex-1 bg-cream-50 dark:bg-night-800">
      <View className="flex-1 items-center justify-center gap-16">
        <Animated.View style={styleA} className="h-24 w-24 items-center justify-center rounded-xs bg-primary-500">
          <Text className="font-bold text-white">A (1x)</Text>
        </Animated.View>

        <Animated.View style={styleB} className="h-24 w-24 items-center justify-center rounded-xs bg-warning-500">
