...
export default function ParallelScreen() {
  ...
  return (
    <View className="h-100 bg-cream-50 dark:bg-night-800">
      ...
      <View className="gap-3 px-6 pb-8">
        <Button className="items-center rounded-xs bg-warning-500 py-3 active:bg-warning-600" label="Play Parallel" variant="warning" onPress={play} />
      </View>
    </View>
  );
}
