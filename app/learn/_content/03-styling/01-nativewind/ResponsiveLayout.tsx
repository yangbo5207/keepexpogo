    ...
    <View className="flex-1 gap-4 p-4">
      ...
      <View>
        ...
        <View className="flex-col gap-3 md:flex-row">
          <View className="flex-1 items-center rounded-xs bg-rose-100 p-4 dark:bg-rose-900/30">
            <Text className="font-semibold text-rose-700 dark:text-rose-300">Item A</Text>
          </View>
          <View className="flex-1 items-center rounded-xs bg-emerald-100 p-4 dark:bg-emerald-900/30">
            <Text className="font-semibold text-emerald-700 dark:text-emerald-300">Item B</Text>
          </View>
          <View className="flex-1 items-center rounded-xs bg-violet-100 p-4 dark:bg-violet-900/30">
      ...
      <View>
        ...
        <View className="gap-2 sm:gap-4 md:gap-6">
          <View className="h-12 rounded-xs bg-sky-500 p-3 sm:h-16 md:h-20">
            <Text className="text-sm font-semibold text-cream-50 sm:text-base md:text-lg">
              高度随断点增长
            </Text>
          </View>
          <View className="flex-row gap-2">
            <View className="h-10 flex-1 items-center justify-center rounded-xs bg-amber-400">
      ...
      <View>
        ...
        <View className="rounded-xs bg-cream-100 p-4 dark:bg-night-700">
          <Text className="text-base font-bold text-cream-800 sm:text-lg md:text-2xl dark:text-night-50">
            This text scales with screen size
          </Text>
          <Text className="mt-1 text-xs text-cream-500 sm:text-sm md:text-base dark:text-cream-400">
