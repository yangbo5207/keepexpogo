  ...
  if (isLoading) {
    return (
      <View className="flex-1 items-center justify-center bg-indigo-600 dark:bg-indigo-900">
        ...
        <Text className="mt-4 text-xl font-bold text-white">MyApp</Text>
        <Text className="mt-1 text-sm text-indigo-300">Secure & Protected</Text>
        <View className="mt-8 h-1 w-48 overflow-hidden rounded-full bg-indigo-400/30">
          <View className="h-full rounded-full bg-white" style={{ width: `${splashProgress}%` }} />
        </View>
        <Text className="mt-2 font-mono text-xs text-indigo-300">
