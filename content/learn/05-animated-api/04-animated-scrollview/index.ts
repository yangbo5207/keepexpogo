  ...
  demos: [
    {
      ...
      route: '/learn/05-animated-api/04-animated-scrollview/collapsing-header',
    },
    {
      ...
      route: '/learn/05-animated-api/04-animated-scrollview/parallax-list',
    },
    {
      ...
      route: '/learn/05-animated-api/04-animated-scrollview/page-indicator',
    },
  ],
};
